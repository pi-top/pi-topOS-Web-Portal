...
jest.mock("../../../services/enableDeviceRegistrationService");
...
const enableDeviceRegistrationServiceMock = enableDeviceRegistrationService as jest.Mock;
...
const mockServices = [
  ...
  enableDeviceRegistrationServiceMock,
...
describe("RestartPageContainer", () => {
  ...
  describe("on restart click", () => {
    ...
    describe('when enable device registration fails', () => {
      beforeEach(() => {
        enableDeviceRegistrationServiceMock.mockRejectedValue(new Error());
      });
