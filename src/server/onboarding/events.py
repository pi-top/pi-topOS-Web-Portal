...
def create_emit_os_prepare_upgrade_message(ws):
    def emit_os_prepare_upgrade_message(message_type: MessageType, status_message: str, percent: float) -> None:
        data = {
...
def create_emit_os_upgrade_message(ws):
    def emit_os_upgrade_message(message_type: MessageType, status_message: str, percent: float) -> None:
        data = {
